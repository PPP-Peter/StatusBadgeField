...
// 2*/
//import storage from 'laravel-nova/storage/BelongsToFieldStorage'

//../../../../vendor/laravel/nova/resources/js/fields/Form/
//import filled from 'laravel-nova/util/filled'

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ['resourceName', 'resourceId', 'field'],
  /*2*/
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_3__.FormField, laravel_nova__WEBPACK_IMPORTED_MODULE_3__.DependentFormField, laravel_nova__WEBPACK_IMPORTED_MODULE_3__.HandlesValidationErrors
  //PerformsSearches,
  //TogglesTrashed,
  ],
  ...
  methods: {
    ...
    getAvailableResources: function getAvailableResources() {
      var _this2 = this;
      Nova.$progress.start();
      return storage.fetchAvailableResources(this.resourceName, this.field.attribute, this.queryParams).then(function (_ref) {
        ...
        if (_this2.viaRelatedResource) {
          var selectedResource = lodash_find__WEBPACK_IMPORTED_MODULE_0___default()(resources, function (r) {
            return _this2.isSelectedResourceId(r.value);
          });
          if (lodash_isNil__WEBPACK_IMPORTED_MODULE_2___default()(selectedResource) && !_this2.shouldIgnoresViaRelatedResource) {
            return Nova.visit('/404');
          }
        }

        // Turn off initializing the existing resource after the first time
        if (_this2.useSearchInput) {
        ...
        this.updateQueryString({
          ...
          Nova.$router.reload({
            onSuccess: function onSuccess() {
              _this6.initializingWithExistingResource = false;
              _this6.initializeComponent();
            }
          });
        });
      } else {
    ...
    onSyncedField: function onSyncedField() {
      ...
      var emitChangesEvent = !this.isSelectedResourceId(this.currentField.value);
      this.initializeComponent();
    ...
    isSelectedResourceId: function isSelectedResourceId(value) {
      ...
      return !lodash_isNil__WEBPACK_IMPORTED_MODULE_2___default()(value) && (value === null || value === void 0 ? void 0 : value.toString()) === ((_this$selectedResourc = this.selectedResourceId) === null || _this$selectedResourc === void 0 ? void 0 : _this$selectedResourc.toString());
    }
  },
  computed: {
    /**
     ...
     */
    viaRelatedResource: function viaRelatedResource() {
    ...
    shouldSelectInitialResource: function shouldSelectInitialResource() {
      return Boolean(this.editingExistingResource || this.viaRelatedResource || this.currentField.value);
    },
    /**
    ...
    authorizedToCreate: function authorizedToCreate() {
      ...
      return lodash_find__WEBPACK_IMPORTED_MODULE_0___default()(Nova.config('resources'), function (resource) {
        return resource.uriKey === _this7.field.resourceName;
      }).authorizedToCreate;
    },
    canShowNewRelationModal: function canShowNewRelationModal() {
      return this.currentField.showCreateRelationButton && !this.shownViaNewRelationModal && !this.viaRelatedResource && !this.currentlyIsReadonly && this.authorizedToCreate;
    },
    /**
    ...
    filteredResources: function filteredResources() {
      ...
      if (!this.isSearchable) {
        return this.availableResources.filter(function (option) {
          return option.display.toLowerCase().indexOf(_this8.search.toLowerCase()) > -1 || new String(option.value).indexOf(_this8.search) > -1;
        });
      }
      return this.availableResources;
    },
    shouldIgnoresViaRelatedResource: function shouldIgnoresViaRelatedResource() {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [$options.useSearchInput ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_SearchInput, {
        key: 0,
        "data-testid": "".concat($props.field.resourceName, "-search-input"),
        ...
        clearable: _ctx.currentField.nullable || $options.editingExistingResource || $options.viaRelatedResource || _ctx.createdViaRelationModal,
        trackBy: "value",
        "class": "w-full",
        mode: _ctx.mode
      }, {
        ...
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["data-testid", "disabled", "onInput", "onClear", "onSelected", "error", "debounce", "value", "data", "clearable", "mode"])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_SelectControl, {
        key: 1,
        "class": "w-full",
        "select-classes": {
          'form-input-border-error': _ctx.hasError
        },
        "data-testid": $props.field.resourceName,
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          ...
          }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.placeholder), 9 /* TEXT, PROPS */, _hoisted_5)];
        }),
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["select-classes", "data-testid", "dusk", "disabled", "options", "selected", "onChange"])), $options.canShowNewRelationModal ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_CreateRelationButton, {
        key: 2,
        onClick: $options.openRelationModal,
        dusk: "".concat($props.field.attribute, "-inline-create")
      }, null, 8 /* PROPS */, ["onClick", "dusk"])), [[_directive_tooltip, _ctx.__('Create :resource', {
        resource: $props.field.singularLabel
      })]]) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_CreateRelationModal, {
        show: $options.canShowNewRelationModal && _ctx.relationModalOpen,
        size: $props.field.modalSize,
      ...
      }, null, 8 /* PROPS */, ["show", "size", "onSetResource", "onCreateCancelled", "resource-name", "resource-id", "via-relationship", "via-resource", "via-resource-id"]), $options.shouldShowTrashed ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_TrashedCheckbox, {
        key: 0,
        "class": "mt-3",
        "resource-name": $props.field.resourceName,
        checked: _ctx.withTrashed,
        onInput: $options.toggleWithTrashed
      }, null, 8 /* PROPS */, ["resource-name", "checked", "onInput"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)];
    }),
    _: 1 /* STABLE */
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.fieldValue), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  }, [$options.fieldValue ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  ...
  }, null, 8 /* PROPS */, _hoisted_2)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.fieldValue), 1 /* TEXT */))], 64 /* STABLE_FRAGMENT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_4, "—"))], 2 /* CLASS */)], 64 /* STABLE_FRAGMENT */);
}
...
Nova.booting(function (app, store) {
  app.component('index-status-badge-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-status-badge-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_2__["default"]);
  app.component('form-status-badge-field', _components_FormField__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
/* harmony import */ var C_laragon_www_test_projekt_nova_components_StatusBadgeField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,C_laragon_www_test_projekt_nova_components_StatusBadgeField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwame_status_badge_field"] = self["webpackChunkwame_status_badge_field"] || [];
